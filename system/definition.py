...
from system.hero.hero_info import agility, strenght, life, lvl, next_lvl,  luck, exper
# from system.hero.hero_info import agility, strenght, life, lvl, next_lvl, hero_name, hero_died, luck, quantity_mob, gold(), exper
from system.modules import module_wallet, module_more_statistics, module_loot
# module_expended_statics, module_cash_switch
